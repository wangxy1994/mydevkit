 ...
 * 系统版本: 3.0.0.1
 * 开发人员:jiangyh
 * 开发时间:2010-4-17 下午04:21:38
 * 审核人员:
 * 相关文档:
 * 修改记录: 修改日期      修改人员    修改说明
 *         2010/09/04 jiangyh   增加对字符串的截取的支持（中文按两个字节计算，采用GBK编码计算）
 *         2010/12/28 jiangyh   增加fix0BeforeString
...
public class DataUtil {
    ...
    public static final String VERSION="@system 资金交易风险管理系统V2.0  @version 2.0.0.3  @lastModiDate  2015-04-17  @describe 增加setRoundingMode(RoundingMode.HALF_UP)保证四舍五入，否则转化会有问题，以转化4位小数为例，99.12345->99.1234，而99.123456->99.1235";
